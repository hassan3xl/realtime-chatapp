...
export const chat = [
  {
    ...
    message: "Hi, I've run into an error with my script file.",
    sentBy: "sender",
    id: 1,
  },
  {
  ...
  },
  {
    ...
    message: "It says the file doesn't exist.",
    sentBy: "sender",
    id: 3,
  },
  {
    ...
    message:
      "Check if you are in the right directory. That's the most common reason.",
    sentBy: "receiver",
    id: 4,
  },
  {
